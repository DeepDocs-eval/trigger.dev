...
Create a [transformation](https://hookdeck.com/docs/transformations) only if you need to modify the body. Trigger.dev task trigger expects the request body directly as the task payload:
